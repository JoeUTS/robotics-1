...
# NOTE: This code is just a modified version of the turtlebot3_gazebo spawn_turtlebot3 launch file
...
def generate_launch_description():
    ...
    declare_yaw_position_cmd = DeclareLaunchArgument(
        'yaw_pose', default_value='1.570796',
        description='Specify namespace of the robot')
